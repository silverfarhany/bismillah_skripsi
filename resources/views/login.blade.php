			...
			<div class="login-header py-10 flex-column-auto">
				<div class="container d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between">
					...
					<a href="#" class="flex-column-auto py-5 py-md-0">
						<img src="../../public/logoLen.png" alt="logo" class="h-50px" />
					</a>
					<!--end::Logo--> --}}
				</div>
			</div>
						...
						<div class="login-form login-signin">
							...
							<form action="/actionlogin" method="post" class="form w-xxl-550px rounded-lg p-20" novalidate="novalidate">
								...
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">PT.Len Industri (Persero)</h3>
								</div>
								<!--begin::Title-->
								...
								<div class="pb-lg-0 pb-5">
									<button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-7 py-3 my-3 mr-2">LogIn</button>
									<a type="button" href="/regis" class="btn btn-light-primary font-weight-bolder font-size-h6 px-7 py-3 my-3 mr-2">Regis</a>
									<a type="button" href="/pengajuanKP" class="btn btn-light-success font-weight-bolder font-size-h6 px-7 py-3 my-3">Ajukan PKL</a>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
