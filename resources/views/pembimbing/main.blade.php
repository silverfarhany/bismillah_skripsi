                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Peserta PKL</span>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Data Kebutuhan PKL</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/sertifikat/upload" class="menu-link menu-toggle">
                                    <i class="menu-icon flaticon2-file"></i>
                                    <span class="menu-text">Sertifikasi Peserta PKL</span>
                            ...
                            <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
                                ...
                                <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
                                    <h3 class="font-weight-bold m-0">{{Session::get('name')}}
                                        <small class="text-muted font-size-sm ml-2">{{Session::get('roll') == 1 ? 'Pembimbing' : (Session::get('roll') == 2 ? 'Peserta' : 'Tim HR')}}</small>
                                    </h3>
                                ...
                                <div class="offcanvas-content pr-5 mr-n5">
                                    <a href="/editProfile" class="btn btn-hover-bg-primary btn-text-primary btn-hover-text-white border-0 font-weight-bold mr-2">Edit Profile</a>
