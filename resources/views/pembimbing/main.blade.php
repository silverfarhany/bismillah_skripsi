                        ...
                        <ul class="menu-nav">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item menu-item-parent" aria-haspopup="true">
                                            <span class="menu-link">
                                                <span class="menu-text">Data diri peserta</span>
                                            </span>
                                        </li>
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="/pengajuan" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Data Pengajuan</span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="/aktifasi" class="menu-link menu-toggle">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Aktifasi Peserta</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/alldata" class="menu-link">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Kelola Data Peserta</span>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Data Kebutuhan KP</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                            ...
                            <li class="menu-section">
                                <h4 class="menu-text">Finishing</h4>
                                <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                            </li>
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <i class="menu-icon flaticon2-file"></i>
                                    <span class="menu-text">Sertifikasi Peserta KP</span>
                ...
                <div class="topbar">
                    ...
                    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
                        ...
                        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
                            <h3 class="font-weight-bold m-0">Nama User
                                <small class="text-muted font-size-sm ml-2">Role</small>
                            </h3>
                        ...
                        <div class="offcanvas-content pr-5 mr-n5">
                            <a href="#"
                                class="btn btn-hover-bg-primary btn-text-primary btn-hover-text-white border-0 font-weight-bold mr-2">Edit
                                Profile</a>
                            <a href="/logout"
                                class="btn btn-hover-bg-danger btn-text-danger btn-hover-text-white border-0 font-weight-bold mr-2">Logout</a>
                        </div>
                    </div>
                </div>
                <!--end::Topbar-->
