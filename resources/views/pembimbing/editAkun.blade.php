    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input type="password" name="password_lama" class="form-control form-control-lg form-control-solid mb-2" value="" placeholder="Password Saat Ini" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label text-alert">Password Baru</label>
                    <div class="col-lg-9 col-xl-6">
                        <input type="password" name="password" class="form-control form-control-lg form-control-solid" value="" placeholder="Password Baru" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label text-alert">Konfirmasi Password</label>
                    <div class="col-lg-9 col-xl-6">
                        <input type="password" name="password_confirmation" class="form-control form-control-lg form-control-solid" value="" placeholder="Konfirmasi Password" />
                    </div>
                </div>
            </div>
