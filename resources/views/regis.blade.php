						...
						<div class="login-form login-signin">
							...
							<form action="/actionregis" method="post" class="form w-xxl-550px rounded-lg p-20" novalidate="novalidate" id="kt_login_signup_form">
								...
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Registrasi</h3>
								...
								<div class="form-group ">
									@csrf
									<input class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6  @error('fullname') is-invalid @enderror" type="text" placeholder="Nama Lengkap" name="fullname" autocomplete="off" />
								</div>
								@error('fullname')
								...
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6  @error('cpassword') is-invalid @enderror" type="password" placeholder="Konfirmasi password" name="password_confirmation" autocomplete="off" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
