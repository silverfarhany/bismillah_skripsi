...
<div class="card card-custom">
    ...
    <form method="POST" action ="/editMember" id="editMember">
     ...
     <div class="card-body">
      ...
      <option value="{{ $mentors->find($member->mentors_id) }}">{{ $mentors->find($member->mentors_id)->name }}</option>
          @endforeach
      </select>
       </div>
      </div>
      <div class="form-group row">
       ...
       <div class="col-10">
        ...
        <option value="{{ $division->find($member->divisions_id) }}">{{ $division->find($member->division_id)->name }}</option>
        @endforeach
        </select>
       </div>
      </div>
      ...
      <div class="form-group row">
       ...
       <div class="form-group row">
        ...
        <div class="col-10">
         ...
         value="{{ $member->internship_letter }}"/>
        </div>
       </div>  
       <div class="form-group row">
